...
const Home = ({isAuthenticated})=> {
  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className={`navbar-header`}>
          ...
          <a className={`${styles.navbarBrand} navbar-brand`} href="#">Light learning platform </a>
        </div>
      ...
      <div className={styles.bannerTitle}>
        <h1 className={styles.bannerHead}>Enjoy free courses powered by Google Gemini</h1>
        <p className={styles.bannerLead}>Light is a high quality application that delivers videos in p2p to ensure nobody is left behinde
        .It's free and works on the web.</p>
        <br/>
    ...
    <div className={styles.headline}>What can you do with Light?</div>
      <div className={styles.contentItem} >
        <div className={styles.headText}>Connect with google gemini teacher</div>
      ...
      <div className={styles.contentItem} >
        <div className={styles.contentImg}>
              <img className={styles.contentImgImg} src="/static/images/business-meeting.svg" alt="webinar" />
        </div>
            <div className={styles.headText}>Host your Course meetings</div>
      </div>
          <div className={styles.contentItem} >
            <div className={styles.contentImg}>
      ...
      <div className={styles.contentItem} >
        <div className={styles.headText}>Hangout with your classmate and family</div>
    ...
    <div className={styles.reminder}>
      ...
      <Button title="Try Light now" onClickHandler={onTryNowBtnClick}/>
    </div>
